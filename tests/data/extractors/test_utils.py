...
from data.extractors.utils import ExtractorChoices, get_extractor_class
...
def test_get_extractor_class(extractor_choice, expected):
    assert get_extractor_class(extractor_choice) is expected
